...
var getSortedNodesByImportOrder = function (nodes, options) {
    ...
    var hasUserProvidedSeparators = options.importOrder.includes(constants_1.SEPARATOR_SPECIAL_WORD);
    var safeToAddNewLine = false;
    for (var _a = 0, importOrder_1 = importOrder; _a < importOrder_1.length; _a++) {
        ...
        if (importOrderSeparation && group === constants_1.SEPARATOR_SPECIAL_WORD && safeToAddNewLine) {
